...
if __name__ == '__main__':
    ...
    train_and_evaluate(model=model, train_data=train_data, val_data=val_data, data_loader=data_loader,
                       optimizer=optimizer, loss_fn=loss_fn, metrics=metrics,
                       params=params, model_dir=args.model_dir, restore_file=args.restore_file)
